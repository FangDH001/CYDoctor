...
#pods管理方式（二选一）
    要求CocoaPods版本为1.4.0.beta.2及以上（具体安装方法请自行查阅相关资料）
    ...
    source 'http://git.ciyun.cn/fangdonghai/DHSpecs.git'

    target 'TestPodCYD' do
...
#项目设置
    ##1.因为慈云医生APP可能会访问http请求，所以需要在项目Info.plist中添加一下键值对：
